...
public class GeneralExample {
     ...
     * @return
     */
    public static Example getConditionAndOrderExample(Class clazz, String orderStr, String conditionStr) {
        Example example = new Example(clazz);
        example.setOrderByClause(orderStr);
        example.createCriteria().andCondition(" " + conditionStr + " ");
        return example;
    ...
    public static Example getConditionAndGroupAndOrderExample(Class clazz, String orderStr, String groupStr, String conditionStr) {
        Example example = new Example(clazz);
        example.setOrderByClause(orderStr);
        example.createCriteria().andCondition(" " + conditionStr + " ");
        example.setCountProperty(groupStr);
        return example;
    }

    public static Example getConditionAndGroupExample(Class clazz, String groupStr, String conditionStr) {
        Example example = new Example(clazz);
        example.createCriteria().andCondition(" " + conditionStr + " ");
        example.setCountProperty(groupStr);
        return example;
