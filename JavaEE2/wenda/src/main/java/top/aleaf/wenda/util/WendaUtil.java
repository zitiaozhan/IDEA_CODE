...
public class WendaUtil {
    public static final Logger logger = LoggerFactory.getLogger(WendaUtil.class);
    ...
    public static final int ANONYMOUSID= 4;
    public static final int ADMIN_USER= 5;
    public static final int ENTITY_MAIL= 02;
